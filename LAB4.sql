...
(
    ...
    contests_character_varying VARCHAR(255),
    value_real INT,
    warehouse_integer INT
);

INSERT INTO Boxes(code_character, contests_character_varying, value_real, warehouse_integer)
VALUES
    ('0MN7', 'Rocks', 180, 3 ),
    ('4H8P', 'Rocks', 250, 1),
    ('4RT3', 'Scissors', 190, 4 ),
...
SELECT distinct contests_character_varying from Boxes; --6
...
INSERT INTO Boxes(code_character, contests_character_varying, value_real, warehouse_integer) --10
